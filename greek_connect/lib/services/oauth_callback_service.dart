// lib/services/oauth_callback_service.dart
//
// Web-only service that handles the Okta OIDC redirect callback.
// Isolated here so main.dart stays thin and this concern is testable.
